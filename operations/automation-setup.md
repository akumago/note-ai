...
| --- | --- | --- | --- |
| 毎夕 note リサーチ部 | Codex Business内で5部署リサーチとネタ精査を回す | 毎日19時 | `outputs/research/`, `outputs/topic-queue/` |
| 毎晩 note 制作部 | 承認済みネタからドラフトと投稿パッケージを作る | 毎日22時 | `outputs/drafts/`, `outputs/post-ready/` |
